...
while True:
    ...
    if inFrame == 1:
        ...
        cv2.putText(frm, "PLEASE BE IN FRAME", (20,200), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0,255,0),4)
...
if isAlive == 0:
    cv2.putText(frm, "DEAD!!!", (50, 200), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,0,255), 4)
    cv2.imshow("Main Window", frm)

if winner == 1:
    cv2.putText(frm, "WINNER!!!", (50,200), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0), 4)
    cv2.imshow("Main Window", frm)
